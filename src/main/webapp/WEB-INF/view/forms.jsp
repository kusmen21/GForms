 ...
 <!-- Page Content -->
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-md-6">  
                	<c:url value="/fillForm/" var="fillForm" />   
                	<c:url value="/showForm/" var="showForm" />   
                	<c:forEach var="form" items="${createdForms}">               
                   		<h3><a href="${fillForm}${form.id}">${form.name}</a></h3>
                   		<a href="${fillForm}${form.id}"><button class="btn btn-default">Fill in form</button></a>
                   		<a href="${showForm}${form.id}"><button class="btn btn-default">Show answers</button></a>
                   		<br>
                   </c:forEach>            
                </div>
            </div>	
